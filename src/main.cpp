...
unsigned int nTargetSpacing = 2 * 60; // 3 minutes
...
const string strMessageMagic = "FreakChain Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "FreakChain", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "FreakChain, the freakiest of all chains. April 12, 2020(Easter).";
        CTransaction txNew;
        txNew.nTime = 1583930978;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1583930978;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 57604 : 57604;
	 ...
	 if (true  && (block.GetHash() != hashGenesisBlock)) {
        ...
        assert(block.hashMerkleRoot == uint256("0xa9554b71e20ced31b55909b03ec2635ccaf36ef9c102058443cb2df8000fd68d"));
    ...
    string strPubKey = "04ee014146af3e28c777816e4fad9555c1f4f609de4bb9e311e9b5ce863bdd42b3a1ee7fa051313b5ee16a2f91e60cc5e3539f0282f52fb7b8960d526cdee189c9";
